...
// ============================================================================
// 1. نظام شاشة تسجيل الدخول الأمني بصورتك الجديدة
// ============================================================================
...
// ============================================================================
// 5. الداش بورد المطور (لوحة تحكم الإدارة بصورتك الجديدة)
// ============================================================================
    ...
    window.addEventListener('beforeinstallprompt', (e) => {
        ...
        if(!document.getElementById('install-app-banner')) {
            ...
            installBanner.innerHTML = `
                <div style="display:flex; align-items:center; gap:10px;">
                    <img src="1234.jpg" alt="Logo" style="width: 45px; height: 45px; border-radius: 10px; object-fit: cover; box-shadow: 0 2px 8px rgba(0,0,0,0.4);">
                    <div style="font-size:0.9rem;">
                        <strong style="display:block;">تثبيت التطبيق</strong>
                        <span style="font-size:0.75rem; color:#94a3b8;">للدخول السريع والمباشر</span>
                    </div>
                </div>
                <div style="display:flex; gap:10px;">
