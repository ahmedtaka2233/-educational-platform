...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // تم إصلاح الزر: إزالة الـ hidden-section عند النقر لتظهر النافذة بنجاح
    ...
    async function sendImmersiveQuestion() {
        ...
        // إرسال تعليمات ذكية مخصصة للروبوت بناءً على مرحلة الطالب المختارة
        ...
        let customPrompt = "MANDATORY_STRICT_INSTRUCTION: YOU ARE A FRIENDLY, HUMAN-LIKE EXPERT EGYPTIAN TEACHER. ANSWER IN ARABIC. ";
