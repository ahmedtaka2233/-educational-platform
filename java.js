        ...
        snapshot.forEach(doc => {
            ...
            rowsHtml += `
                <tr style="border-bottom: 1px solid #f1f5f9;">
                    ...
                    <td style="padding: 12px 15px; font-weight: bold; color: #047857;">${amountCalculated} ج.m</td>
                    <td style="padding: 12px 15px; color: #64748b;">${subDate}</td>
                </tr>
            `;
        });

        if (document.getElementById('report-total-revenue')) document.getElementById('report-total-revenue').innerText = totalIncome + " ج.m";
