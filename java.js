...
window.addEventListener('load', () => {
    ...
    }, 2500); // الشاشة ستستمر لمدة ثانيتين ونصف
});
...
// 1. قائمة أرقام الإدارة العليا (تظهر لهم لوحة التحكم والداش بورد ويتحكمون في كل شيء)
const AUTHORIZED_ADMIN_PHONES = [
    "01026336159"
];

// 2. قائمة أرقام مستثناة من قفل الأجهزة (العائلة والمشرفين - يدخلون من أي جهاز مجاناً)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ============================================================================
    // 11. نظام تحويل الموقع إلى تطبيق (PWA) مع نافذة تثبيت زجاجية فخمة
    // ============================================================================
    let deferredPrompt;
    ...
    window.addEventListener('beforeinstallprompt', (e) => {
        ...
        }, 3000); // تظهر نافذة التثبيت بعد 3 ثوانٍ من فتح الموقع
    });
