...
ALL MCQs AND TRUE/FALSE MUST HAVE DETAILED REASONS. THE TONE MUST BE 100% IDENTICAL TO OFFICIAL EGYPTIAN EXAMS. DO NOT DEVIATE.`;
    ...
    // ============================================================================
    // دالة بناء وتفعيل المعلم ثلاثي الأبعاد الاحترافي (GLTF Model + Lip Sync)
    // ============================================================================
    let robotModel = null;
    ...
    function init3DRobot() {
        ...
        // رابط مجسم جاهز من Ready Player Me
        const modelUrl = 'https://models.readyplayer.me/64b55a9b8b9c4f001c2b5e1a.glb'; 

        loader.load(modelUrl, function(gltf) {
            robotModel = gltf.scene;
            
            robotModel.position.set(0, -1.5, 0); 
            ...
            console.error('حدث خطأ أثناء تحميل المجسم 3D:', error);
        });
        ...
        function animate() {
            ...
            if (robotModel) {
                const targetRotationX = mouseX * 0.3;
                const targetRotationY = mouseY * 0.2;
                
                robotModel.rotation.y += (targetRotationX - robotModel.rotation.y) * 0.05;
                robotModel.rotation.x += (-targetRotationY - robotModel.rotation.x) * 0.05;

                robotModel.position.y = -1.5 + Math.sin(time * 2) * 0.02;
                    ...
                    robotModel.traverse((child) => {
                        if (child.isMesh && child.morphTargetInfluences) {
                            ...
                            if (mouthOpenIndex !== undefined) {
                                child.morphTargetInfluences[mouthOpenIndex] = Math.abs(Math.sin(time * 15)) * 0.8;
                            }
                        }
                    });
                } else {
