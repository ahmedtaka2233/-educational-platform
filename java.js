...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ربط زرار الروبوت العائم عشان يفتح الشاشة الجديدة الغامرة بدل القديمة
    ...
    // نفس منطق الشات للشاشة الغامرة (كتمهيد للربط بالـ 3D لاحقاً)
        ...
        try {
            const response = await fetch('/api/analyze', {
                ...
                body: JSON.stringify({
                    ...
                    message: text,
                    context: globalLessonContext,
                    strict_prompt_command: "MANDATORY_STRICT_INSTRUCTION: YOU ARE A FRIENDLY, HUMAN-LIKE EXPERT TEACHER. ANSWER IN ARABIC."
                })
            });
